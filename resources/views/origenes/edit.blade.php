...
<!-- Datos -->   
        <h3 class="text-center text-bold text-2xl">Edición de origen</h3>
        <hr class="bg-gray-700 h-1 w-full mx-auto">
        <div class="div">
        <table>
        <form action="{{route('origenes.update', $origen)}}" method="post">            
            ...
            <div class="flex flex-row mt-2">
                    ...
                    <div class="w-80"><input class="h-6 border-0 bg-gray-200 w-72  " type="text" name="descorigen" value="{{$origen->descorigen}}"></div>
            ...
            <x-jet-danger-button class="mt-6" type="submit" class="ml-2">Modificar origen</x-jet-danger-button>              
