...
<!-- Datos -->   
        ...
        <form action="{{route('users.update', $user)}}" method="post">            
            ...
            <div class="flex flex-row mt-2">
                    ...
                    <div class="w-80"><input class="h-6 border-0 bg-gray-200 w-72  " type="text"  name="origen_id" value="{{$user->origen_id}}"></div>
                    @error('origen_id')<small class="text-bold text-red-700">*{{$message}}</small>@enderror
            </div>
            <div class="flex flex-row mt-2">
            ...
            <x-jet-danger-button class="mt-6" type="submit" class="ml-2">Modificar cliente</x-jet-danger-button>              
