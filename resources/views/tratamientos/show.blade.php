...
<!-- Datos -->   
        <h3 class="text-center text-bold text-2xl">Eliminar tratamiento</h3>
        <hr class="bg-gray-700 h-1 w-full mx-auto">
        <div class="div">
        <table>
        <form action="{{route('tratamientos.destroy', $trat)}}" method="post">            
            ...
            <div class="flex flex-row mt-2">
                    <div class="bg-red-200 w-20 mr-4 h-6">Cod :</div>
                    <div class="w-80"><input class="h-6 border-0 bg-gray-200 w-72  " type="text" disabled name="codtra" value="{{$trat->codtra}}"></div>
                    @error('cod')<small class="text-bold text-red-700">*{{$message}}</small>@enderror
            </div>
            <div class="flex flex-row mt-2">
            ...
            <x-jet-danger-button class="mt-6" type="submit" class="ml-2">Eliminar tratamiento</x-jet-danger-button>              
