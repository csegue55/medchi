...
<!-- Datos -->   
        <h3 class="text-center text-bold text-2xl">Eliminar visita</h3>
        <hr class="bg-gray-700 h-1 w-full mx-auto">
        <div class="div">
        <table>
        <form action="{{route('sesiones.destroy', $sesion)}}" method="post">            
            ...
            <div class="flex flex-row mt-2">
                    <div class="bg-red-200 w-20 mr-4 h-6">Visita :</div>
            ...
            <div class="flex flex-row mt-2">
                    <div class="bg-red-200 w-20 mr-4 h-6">Cliente :</div>
            ...
            <x-jet-danger-button class="mt-6" type="submit" class="ml-2">Eliminar visita</x-jet-danger-button>              
